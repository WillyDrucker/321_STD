...
**Migration exception:** when the `-Setup` migration capture drives this skill, ambiguous-home content routes to SESSION LIFO instead of dropping. The DROP row applies to routine runs.
