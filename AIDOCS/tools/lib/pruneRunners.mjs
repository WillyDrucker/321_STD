// pruneRunners.mjs - the I/O-bearing prune orchestration. Reads the target
// file(s), runs the bottom-up drop walk (pure algorithms in pruneSelection.mjs),
// writes the trimmed files, and archives the dropped content. pruneSelection.mjs
// owns the pure "what to drop" decision; this module is the side-effecting half.
//
...
// are skipped - new content never archives immediately on landing. Both prune.mjs
// (the CLI command) and commit.mjs import these runners, so they live here in
// lib/ rather than in either command - commands import lib, never each other.
